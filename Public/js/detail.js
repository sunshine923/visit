$(function () {
    ...
    if(type==1){
        ...
        $('.mp1').html(`<img src="/visit/Public/img/push.png" alt="">`)
        $('.aaa').html(`
        <a href="/visit/index.php/home">
					<div class="sty"  style="width:48px">
						<p>TUIJIAN</p>
						<div>
							<span style="width: 44px"></span>
    ...
    function show(data){
        ...
        `
            ...
            <li>
				<a href="/visit/index.php/home">${data[0]['title']}
				<div class="blue"><img src="/visit/Public/img/blue.png" alt=""></div>
				</a>
			</li>
			<li><a href="/visit/index.php/tour">${data[1]['title']}</a></li>
			<li style="border-radius: 0 0 9px 0"><a href="/visit/index.php/newslist">${data[2]['title']}</a></li>
    ...
    $.ajax({
        url:'/visit/index.php/detail/select',
        data:{gid:id},
        dataType:'json',
        success:function (data) {
            fn(data[0])
    ...
    function render(data) {
        ...
        $.each(data,function (index,value) {
            if(value.image && index<5){
                ...
                $('.center').empty();
                $('.center').html(`<img src="${value.image}" alt="">`)
            }
    ...
    let count;
    $.ajax({
        url: '/visit/index.php/detail/page',
        data:{page:1,gid:id},
        dataType: 'json',
    ...
    function fn1(data,page) {
        ...
        $.ajax({
            url: '/visit/index.php/detail/commentCollect',
            data:{page,gid:id},
            dataType: 'json',
            success:function (data) {
                render1(data,page);
    ...
    $.ajax({
        url:'/visit/index.php/detail/commentSelect',
        data:{gid:id},
        dataType:'json',
        success:function (data) {
            comment(data)
    ...
    $('button').on('click',function () {
        $.ajax({
            url:'/visit/index.php/detail/insert',
            data:{message,gid:id},
            success(data){
                if(data=='ok'){
                    text.val('');
    ...
    let gid,gid1;
    $.ajax({
        url:'/visit/index.php/detail/allSelect',
        data:{type},
        dataType:'json',
        success:function (data) {
    ...
    $('.prev>a').on('click',function () {
        $.ajax({
            url:'/visit/index.php/detail/change',
            dataType:'json',
            data:{gid,type},
            success:function (data) {
                location.href=`http://localhost/visit/index.php/detail?gid=${gid}&type=${type}`
            }
        })
    })
    $('.next>a').on('click',function () {
        $.ajax({
            url:'/visit/index.php/detail/change1',
            dataType:'json',
            data:{gid1,type},
            success:function (data) {
                location.href=`http://localhost/visit/index.php/detail?gid=${gid1}&type=${type}`
            }
        })
    })
})